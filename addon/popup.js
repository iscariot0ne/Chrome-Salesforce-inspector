...
function getRecordId(href) {
  ...
  if ((url.hostname.endsWith(".crmforce.mil"))||((url.hostname.endsWith(".salesforce.mil")))) {
  ...
  if ((url.hostname.endsWith(".lightning.crmforce.mil"))||(url.hostname.endsWith(".lightning.salesforce.mil"))) {
    let match;
